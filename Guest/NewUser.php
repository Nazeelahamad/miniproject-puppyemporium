...
if(isset($_POST['submitbtn'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        $insqry = "INSERT INTO tbl_user (user_name, user_address, user_contact, user_email, user_password, place_id,user_created_at) VALUES ('$name', '$address', '$contact', '$email', '$password', '$place',CURRENT_TIMESTAMP)";
        if($con->query($insqry)) {
...
<body>
    <div class="wrapper">
        <div class="title-text">
            <div class="title login"> New User Registration </div>
        </div>
        <div class="form-inner">
            <form id="registrationForm" action="" method="post" enctype="multipart/form-data" class="login" onsubmit="return validateForm()">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" name="contact" id="contact" class="form-control" required placeholder="Enter Contact" pattern="^\d{10}$" title="Please enter a valid 10-digit phone number">
                </div>
                <div class="form-group">
