...
$selqry="select * from tbl_request r inner join tbl_puppy w on r.puppy_id=w.puppy_id inner join tbl_owner k on w.owner_id=k.owner_id inner join tbl_user u on r.user_id=u.user_id where r.request_id=".$_GET['id'];
        ...
        <table style="width: 100%; table-layout: fixed">
          <tr>
            ...
            >
              ...
              >
              	<span
                style="color:#F93;font-size:56px"> PuppyEmporium</span>
