...
session_start();
 ...
 $selQry = "select * from tbl_chat c inner join tbl_user u on (u.user_id=c.chat_touid) or (u.user_id=c.chat_fromuid) where u.user_id='".$_SESSION["uid"]."' order by chat_datetime";
    ...
    {
        if ($datadis["chat_fromoid"]==$_GET["id"]) {

            $selQry1= "select * from tbl_owner where owner_id ='".$_GET["id"]."'";
...
<div class="chat-message is-received">
    <img src="../assets/Files/Seller/Photo/<?php echo $datadis1["owner_photo"] ?>" alt="">
    <div class="message-block">
        <span><?php echo $datadis1["owner_name"] ?></span>
