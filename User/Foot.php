            ...
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="d-flex flex-column justify-content-start">
                        ...
                        <a class="text-body mb-2" href="SearchPuppy.php"><i class="bi bi-arrow-right text-primary me-2"></i>Product</a>
                        <a class="text-body mb-2" href="MyProfile.php"><i class="bi bi-arrow-right text-primary me-2"></i>My Profile</a>
                        <a class="text-body mb-2" href="MyRequest.php"><i class="bi bi-arrow-right text-primary me-2"></i>My Request</a>
