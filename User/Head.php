    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm py-3 py-lg-0 px-3 px-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                ...
                <a href="SearchPuppy.php" class="nav-item nav-link">Product</a>
                <div class="navbar-nav ms-auto py-0">
                <a href="Complaint.php" class="nav-item nav-link">Complaint</a>
                    
                </div>
                <a href="../Logout.php" class="nav-item nav-link nav-contact bg-primary text-white px-5 ms-lg-5">Logout <i class="bi bi-arrow-right"></i></a>
            </div>
        </div>
    </nav>
    <!-- Navbar End -->